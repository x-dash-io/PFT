...
class AppColors {
  ...
  static const Color darkNeutralMedium =
      Color(0xFF64748B); // Medium gray (dark)
  ...
  static const Color darkNeutralBackground =
      Color(0xFF0F172A); // Very dark background
  static const Color darkCardBackground =
      Color(0xFF1E293B); // Card background (dark)
  ...
  static const Color darkWarning =
      Color(0xFFFBBF24); // Amber (brighter for dark)
