...
class _HomeScreenState extends State<HomeScreen> {
  ...
  ({IconData icon, Color color}) _getBillStyling(String billName) {
    ...
    if (name.contains('rent')) return (icon: Icons.house_outlined, color: AppColors.warning);
    if (name.contains('netflix') || name.contains('movie')) return (icon: Icons.movie_outlined, color: AppColors.error);
    if (name.contains('wifi') || name.contains('internet')) return (icon: Icons.wifi, color: AppColors.info);
    if (name.contains('electricity') || name.contains('power')) return (icon: Icons.lightbulb_outline, color: AppColors.warning);
    if (name.contains('water')) return (icon: Icons.water_drop_outlined, color: AppColors.secondary);
    if (name.contains('loan') || name.contains('debt')) return (icon: Icons.credit_card_outlined, color: AppColors.tertiary);
    return (icon: Icons.receipt_long_outlined, color: AppColors.neutralMedium);
  }
                        ...
                        Expanded(
                          child: ListView(
                            ...
                            children: [
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    SummaryCard(
                                      ...
                                      color: _balance >= 0 ? const Color(0xFF1F6FEB) : const Color(0xFFFF9F1C), 
                                      currencySymbol: _currencySymbol
                                    ),
                                  ],
                                ),
                              ...
                              Padding(
                                padding: const EdgeInsets.fromLTRB(24.0, 20.0, 24.0, 12),
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Row(
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        children: [
                                          Icon(Icons.info_outline, size: 14, color: const Color(0xFF9CA3AF)),
                    ...
                    return SizedBox(
                      ...
                      child: Card(
                        ...
                        shape: RoundedRectangleBorder(
                          side: BorderSide(color: status.color.withOpacity(0.2), width: 1.5),
